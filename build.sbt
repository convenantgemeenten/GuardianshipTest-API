...
ThisBuild / organization := "nl.convenantgemeenten.guardianshiptest"
...
lazy val guardianshipTest = project
  .in(file("."))
...
lazy val service = (project in file("service"))
  ...
  .settings(
    ...
    mainClass in Compile := Some("convenantgemeenten.guardianshiptest.service.GuardianshipTestService"),
...
lazy val site = (project in file("site"))
  ...
  .settings(
    micrositeName := "GuardianshipTest-API",
    micrositeDescription := "Services for performing assertions if someone is under legal guardianship.",
    micrositeDataDirectory := (resourceManaged in Compile).value / "site" / "data",
    micrositeBaseUrl := "/GuardianshipTest-API",
    micrositeAuthor := "Thijs Broersen",
    micrositeHomepage := "https://thijsbroersen.github.io/GuardianshipTest-API",
    micrositeGithubOwner := "ThijsBroersen",
    micrositeGithubRepo := "GuardianshipTest-API",
